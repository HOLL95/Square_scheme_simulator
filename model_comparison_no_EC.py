...
dir=os.getcwd()
dir_list=dir.split("/")
source_list=dir_list[:dir_list.index("Square_scheme_simulators")+1] + ["src"]
...
xaxis="time" 
xaxis="potential"
mode="together"#All mechanisms on top of each other
mode="seperate" #Mechanisms plotted seperately
if mode=="seperate":
